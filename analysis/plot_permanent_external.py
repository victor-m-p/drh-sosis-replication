...
# )
labels[1] = labels[1].replace("tattoos/scarification", "tattoos/\nscarification")
labels[2] = labels[2].replace("permanent scarring", "permanent\nscarring")
...
plt.ylim(0, 0.5)
plt.savefig("../figures/permanent_external.pdf", bbox_inches="tight")
plt.savefig("../figures/png/permanent_external.png", bbox_inches="tight", dpi=300)
