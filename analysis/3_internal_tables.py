"""
Format 3_internal.Rmd's saved CSVs (data/model/internal/results) into LaTeX
tables (data/model/internal/tables). diagnostics_* are excluded — convergence QA,
not a paper table.
"""
...
IN = Path("../data/model/internal/results")
OUT = Path("../data/model/internal/tables")
...
for suffix in ["baseline", "phylo"]:
    ...
    write_latex_table(
        ...
        col_labels={"violent_internal": "Internal Conflict", "year_scaled": "Start Year"},
    )
