...
wide_subset = wide_subset.dropna(subset=["violent external", "violent internal"])
...
wide_subset = wide_subset[wide_subset["conflict_type"] != "Internal and external"]
wide_subset = wide_subset.drop(columns={"violent internal", "violent external"})
...
plt.ylim(0, 0.5)
plt.savefig("../figures/transitory_internal.pdf", bbox_inches="tight")
plt.savefig("../figures/png/transitory_internal.png", bbox_inches="tight", dpi=300)
